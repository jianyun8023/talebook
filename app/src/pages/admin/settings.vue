    ...
    data: () => ({
        ...
        },
        {
            ...
            fields: [
                ...
                { icon: "info", key: "meili_search_url", label: "meiliSearch地址(例如 http://10.0.0.1:7700 )" },
                { icon: "info", key: "meili_search_key", label: "meiliSearch鉴权，无则不填 " },
                { icon: "info", key: "meili_search_index", label: "meiliSearch index名称" },
